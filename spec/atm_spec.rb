...
describe Atm do
    let(:account) { instance_double('Account', pin_code: '1234', exp_date: '05/21', account_status: :active)} 
    ...
    it 'reject withdraw if account has insufficient funds' do
        ...
        expect(subject.withdraw(105, '4897', account, :active)).to eq expected_output
    end

    it 'funds reduced at withdraw' do
